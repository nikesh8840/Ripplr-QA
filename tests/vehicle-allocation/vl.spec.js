...
test('test', async ({ page }) => {
  ...
  await page.getByText('Regular').nth(1).click();
  await page.getByText('Regular').nth(2).click();
  await page.getByText('Regular').nth(3).click();
  await page.getByText('Regular').nth(4).click();
  await page.getByText('Regular').nth(5).click();
  await page.getByText('Regular').nth(6).click();
  await page.getByText('Regular').nth(7).click();
  await page.getByText('Regular').nth(8).click();
  await page.getByText('Regular').nth(9).click();
  await page.getByText('Regular').nth(10).click();
